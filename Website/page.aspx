<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True" CodeBehind="page.aspx.cs" Inherits="Content" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="list-news-child">
        ...
        <h1 class="title-content"><%= News.Title %></h1>
        <p class="date-content">Đăng ngày <%= News.CreateDate.ToString("dd - MM - yyyy") %></p>
